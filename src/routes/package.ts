...
export const src_json = {
	...
	modules: {
		...
		'./styletext.js': {
			path: 'styletext.ts',
			declarations: [
				{name: 'black', kind: 'variable'},
				{name: 'red', kind: 'variable'},
				{name: 'green', kind: 'variable'},
				{name: 'yellow', kind: 'variable'},
				{name: 'blue', kind: 'variable'},
				{name: 'magenta', kind: 'variable'},
				{name: 'cyan', kind: 'variable'},
				{name: 'white', kind: 'variable'},
				{name: 'gray', kind: 'variable'},
				{name: 'red_bright', kind: 'variable'},
				{name: 'green_bright', kind: 'variable'},
				{name: 'yellow_bright', kind: 'variable'},
				{name: 'blue_bright', kind: 'variable'},
				{name: 'magenta_bright', kind: 'variable'},
				{name: 'cyan_bright', kind: 'variable'},
				{name: 'white_bright', kind: 'variable'},
				{name: 'bg_black', kind: 'variable'},
				{name: 'bg_red', kind: 'variable'},
				{name: 'bg_green', kind: 'variable'},
				{name: 'bg_yellow', kind: 'variable'},
				{name: 'bg_blue', kind: 'variable'},
				{name: 'bg_magenta', kind: 'variable'},
				{name: 'bg_cyan', kind: 'variable'},
				{name: 'bg_white', kind: 'variable'},
				{name: 'bg_gray', kind: 'variable'},
				{name: 'bg_red_bright', kind: 'variable'},
				{name: 'bg_green_bright', kind: 'variable'},
				{name: 'bg_yellow_bright', kind: 'variable'},
				{name: 'bg_blue_bright', kind: 'variable'},
				{name: 'bg_magenta_bright', kind: 'variable'},
				{name: 'bg_cyan_bright', kind: 'variable'},
				{name: 'bg_white_bright', kind: 'variable'},
			],
		},
		'./timings.js': {
			path: 'timings.ts',

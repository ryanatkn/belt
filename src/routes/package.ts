	...
	modules: {
		...
		'./styletext.js': {
			...
			declarations: [
				...
				{name: 'black_bold', kind: 'variable'},
				{name: 'red_bold', kind: 'variable'},
				{name: 'green_bold', kind: 'variable'},
				{name: 'yellow_bold', kind: 'variable'},
				{name: 'blue_bold', kind: 'variable'},
				{name: 'magenta_bold', kind: 'variable'},
				{name: 'cyan_bold', kind: 'variable'},
				{name: 'white_bold', kind: 'variable'},
				{name: 'gray_bold', kind: 'variable'},

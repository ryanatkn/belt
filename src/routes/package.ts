	...
	modules: {
		...
		'./styletext.js': {
			...
			declarations: [
				...
				{name: 'reset', kind: 'variable'},
				{name: 'bold', kind: 'variable'},
				{name: 'italic', kind: 'variable'},
				{name: 'overlined', kind: 'variable'},
				{name: 'doubleunderline', kind: 'variable'},
				{name: 'framed', kind: 'variable'},
			],
		},
		'./timings.js': {
			path: 'timings.ts',

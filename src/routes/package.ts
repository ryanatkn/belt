	...
	modules: {
		...
		'./git.js': {
			...
			declarations: [
				...
				{name: 'Git_Workspace_Status', kind: 'type'},
				{name: 'git_parse_workspace_status', kind: 'function'},
				{name: 'git_check_workspace', kind: 'function'},
				{name: 'git_workspace_is_clean', kind: 'function'},
				{name: 'git_workspace_is_fully_staged', kind: 'function'},
				{name: 'git_workspace_status_message', kind: 'function'},
